...
class JobApplicantForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'is_married': forms.CheckboxInput(attrs={'class': 'ps-0 border-radius-0px border-color-extra-medium-gray bg-transparent form-control required form-check-input'}),
            'has_children': forms.CheckboxInput(attrs={'class': 'ps-0 border-radius-0px border-color-extra-medium-gray bg-transparent form-control required form-check-input'}),
            ...
            'is_church_member': forms.CheckboxInput(attrs={'class': 'ps-0 border-radius-0px border-color-extra-medium-gray bg-transparent form-control required form-check-input'}),
